...
public class Recherches {
    ...
    public void recherche(String fichier) throws IOException {
        try {
            ...
            MatriceCreuse matrice = new MatriceCreuse(
                    "D:\\353_projet\\french\\matriceCreuse.txt");
        ...
        while(i!=87162){
            ...
            //int id = 0;
            int col = 0;
            File file = new File("treceval130V2.txt");
            if(!file.exists()){
                file.createNewFile();
                ...
                bv.write(130 + "\t" + cste + "\t" + doc[id] + "\t" + id + "\t" + produit[id] + "\t" + "STANDARD");
                bv.write("\n");
    ...
    public static void main(String[] args) throws IOException {
        ...
        I.recherche(/*"Soulèvement d'Indiens dans le sud du Mexique"*/ "D:\\353_projet\\inf353-tests\\C130");
